...
public class SyncMongoDatabase implements MongoDatabase {
    ...
    public MongoCollection<Document> getCollection(final String collectionName) {
        return new SyncMongoCollection<Document>(wrapped.getCollection(collectionName));
    }

    @Override
    public <TDocument> MongoCollection<TDocument> getCollection(final String collectionName, final Class<TDocument> documentClass) {
        return new SyncMongoCollection<TDocument>(wrapped.getCollection(collectionName, documentClass));
    }

    @Override
    public Document runCommand(final Bson command) {
        SyncSubscriber<Document> subscriber = new SyncSubscriber<Document>();
    ...
    @Override
    public <TResult> TResult runCommand(final Bson command, final Class<TResult> tResultClass) {
        throw new UnsupportedOperationException();
    }

    @Override
    public <TResult> TResult runCommand(final Bson command, final ReadPreference readPreference, final Class<TResult> tResultClass) {
        throw new UnsupportedOperationException();
    }
    ...
    @Override
    public <TResult> TResult runCommand(final ClientSession clientSession, final Bson command, final Class<TResult> tResultClass) {
        throw new UnsupportedOperationException();
    }

    @Override
    public <TResult> TResult runCommand(final ClientSession clientSession, final Bson command, final ReadPreference readPreference, final Class<TResult> tResultClass) {
        throw new UnsupportedOperationException();
    }
    ...
    @Override
    public <TResult> ListCollectionsIterable<TResult> listCollections(final Class<TResult> tResultClass) {
        throw new UnsupportedOperationException();
    }
    ...
    @Override
    public <TResult> ListCollectionsIterable<TResult> listCollections(final ClientSession clientSession, final Class<TResult> tResultClass) {
        throw new UnsupportedOperationException();
    }
    ...
    @Override
    public void createCollection(final ClientSession clientSession, final String collectionName, final CreateCollectionOptions createCollectionOptions) {
        throw new UnsupportedOperationException();
    }
    ...
    @Override
    public void createView(final ClientSession clientSession, final String viewName, final String viewOn, final List<? extends Bson> pipeline) {
        throw new UnsupportedOperationException();
    }

    @Override
    public void createView(final ClientSession clientSession, final String viewName, final String viewOn, final List<? extends Bson> pipeline, final CreateViewOptions createViewOptions) {
        throw new UnsupportedOperationException();
    }
