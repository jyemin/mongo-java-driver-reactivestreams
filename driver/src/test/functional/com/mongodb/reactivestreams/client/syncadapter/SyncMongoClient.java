...
public class SyncMongoClient implements MongoClient {
    ...
    public ClientSession startSession() {
        ...
        return new SyncClientSession(subscriber.first(), this);
    }

    private <TResult> SyncSubscriber<TResult> createSubscriber() {
        return new SyncSubscriber<TResult>();
    }
    ...
    @Override
    public <TResult> ListDatabasesIterable<TResult> listDatabases(final ClientSession clientSession, final Class<TResult> tResultClass) {
        throw new UnsupportedOperationException();
    }
